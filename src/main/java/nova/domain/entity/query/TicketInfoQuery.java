...
public class TicketInfoQuery implements Serializable {
    ...
    public TicketInfoQuery(Integer id, String unidadClave, String unidadNombre, String reporteNombre, String area, String folio, String agente, LocalDateTime creado) {
        this.id = id;
        this.agente = agente;
